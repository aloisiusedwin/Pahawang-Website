    ...
    <div className={montserrat.className}>
      ...
      <section className="py-12 px-4 sm:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-700 leading-relaxed mb-6 text-justify">
            Koleksi foto ini merangkum berbagai program kerja inovatif,
            interaksi dengan masyarakat, dan pencapaian yang telah diraih. Dari
            kegiatan pemberdayaan ekonomi hingga program pendidikan, setiap
            gambar menceritakan kisah dedikasi kelompok kami dalam membangun
            desa yang mandiri dan berkelanjutan.
          </p>
          <p className="text-gray-700 leading-relaxed text-justify">
            Mari jelajahi perjalanan inspiratif kelompok kami melalui
            potret-potret yang menggambarkan semangat pengabdian, kerja sama
            tim, dan momen-momen tak terlupakan bersama masyarakat desa. Setiap
            foto adalah bukti nyata kontribusi positif yang telah diberikan
          ...
          {selectedEvent && (
            ...
            >
              <motion.div
                ...
                className="bg-white rounded-xl shadow-lg overflow-hidden max-w-lg md:max-w-xl lg:max-w-2xl w-full max-h-[calc(100vh-2rem)] overflow-y-auto"
              >
                <div className="relative w-full pt-[100%]">
                  {/* Aspect ratio 1:1 */}
                  <motion.img
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 w-full bg-[#ecfccb] text-[#3f6212] hover:bg-[#3f6212] hover:text-white font-medium py-2 px-4 rounded-lg transition-colors mt-4"
                    >
                      <svg
